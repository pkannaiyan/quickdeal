...
class BigBasketScraper(BaseScraper):
    ...
    def __init__(self, pincode: str = None):
        ...
        self._price_range = (0.92, 1.00)  # BigBasket often has best bulk prices
    ...
    def _sample_products(self) -> List[Dict]:
        ...
        if not self._product_database:
            return [
                {"id": "BB1001", "name": "Amul Taaza Toned Fresh Milk", "brand": "Amul", "category": "dairy_bread", "quantity": "1 L", "price": 62, "mrp": 68},
            ]
    ...
    def _convert_to_product(self, item: Dict) -> Product:
        ...
        # Generate proper BigBasket search URL
        search_term = item["name"].replace(" ", "%20")
        product_url = f"https://www.bigbasket.com/ps/?q={search_term}"
